...
def get_data(
    ...
    test_node_set = (
        set(sources[post_train_idx]).union(set(destinations[post_train_idx]))
        if len(post_train_idx) > 0
        else set()
    )
    ...
    print(
        f"The dataset has {full_data.n_interactions} interactions, involving {full_data.n_unique_nodes} different nodes"
    )
    print(
        f"The training dataset has {train_data.n_interactions} interactions, involving {train_data.n_unique_nodes} different nodes"
    )
    print(
        f"The validation dataset has {val_data.n_interactions} interactions, involving {val_data.n_unique_nodes} different nodes"
    )
    print(
        f"The test dataset has {test_data.n_interactions} interactions, involving {test_data.n_unique_nodes} different nodes"
    )
    print(
        f"The new node validation dataset has {new_node_val_data.n_interactions} interactions, involving {new_node_val_data.n_unique_nodes} different nodes"
    )
    print(
        f"The new node test dataset has {new_node_test_data.n_interactions} interactions, involving {new_node_test_data.n_unique_nodes} different nodes"
    )
    print(
